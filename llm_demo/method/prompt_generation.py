...
def find_best_match(question, mapping, threshold=50):
...
def calculate_indicator_lv(year_, stock_name,index_name):
    ...
    "净资产增长率": (["净资产"], "(净资产-上年净资产)/上年净资产 × 100"),
    "销售费用增长率": (["销售费用"], "(销售费用 - 上年销售费用) / 上年销售费用 × 100"),
    "财务费用增长率": (["财务费用"], "(财务费用 - 上年财务费用) / 上年财务费用 × 100"),
    "管理费用增长率": (["管理费用"], "(管理费用 - 上年管理费用) / 上年管理费用 × 100"),
    "研发费用增长率": (["研发费用"], "(研发费用-上年研发费用)/上年研发费用 × 100"),
    "总负债增长率": (["总负债"], "(总负债 - 上年总负债) / 上年总负债 × 100"),
    "流动负债增长率": (["流动负债"], "(流动负债 - 上年流动负债) / 上年流动负债 × 100"),
    "货币资金增长率": (["货币资金"], "(货币资金 - 上年货币资金) /上年货币资金 × 100"),
    "固定资产增长率": (["固定资产"], "(固定资产 - 上年固定资产)/上年固定资产 × 100"),
    "无形资产增长率": (["无形资产"], "(无形资产-上年无形资产)/上年无形资产 × 100"),
    "总资产增长率": (["资产总额"], "(资产总额-上年资产总额)/上年资产总额 × 100"),
    "营业收入增长率": (["营业收入"], "(营业收入-上年营业收入)/上年营业收入 × 100"),
    "营业利润增长率": (["营业利润"], "(营业利润-上年营业利润)/上年营业利润 × 100"),
    "净利润增长率": (["净利润"], "(净利润-上年净利润)/上年净利润 × 100"),
    "现金及现金等价物增长率": (["现金及现金等价物"], "(现金及现金等价物-上年现金及现金等价物)/上年现金及现金等价物 × 100"),
    }
    formula_data = financial_formulas[index_name]
    data_values = {}
    values_str = []
