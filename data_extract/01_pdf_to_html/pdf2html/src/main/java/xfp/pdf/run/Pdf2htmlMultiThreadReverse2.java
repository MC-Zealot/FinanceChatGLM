...
public class Pdf2htmlMultiThreadReverse2 {
    static SimpleDateFormat sdf = new SimpleDateFormat();// 格式化时间
    public Pdf2htmlMultiThreadReverse2() {
...
//            Date date = ;// 获取当前时间
    ...
    public static <T> void Thread(File[] list, int nThread) {
        ...
        for (int i = list.length - 3000; i>=0; i--) {
            File file = list[i];
            try {
                semaphore.acquire();
...
//                    System.out.println("number:" + file.getName());
    ...
    public static void main(String[] args) {
        ...
        Pdf2htmlMultiThreadReverse2 p = new Pdf2htmlMultiThreadReverse2();
